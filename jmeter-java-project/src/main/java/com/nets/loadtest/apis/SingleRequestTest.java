...
/**
 * Simple test for a single API request. Use this to test individual endpoints quickly.
 */
public class SingleRequestTest {
  ...
  public static void main(String[] args) throws Exception {
    ...
    testPlan(threadGroup(1, 1,
        ...
        httpSampler(config.getBaseUrl() + ApiConstants.CIAM_TEST_RSA).children(
        ...
        // Result collectors
        jtlWriter("single-request-results.jtl"), htmlReporter("single-request-report")).run();
