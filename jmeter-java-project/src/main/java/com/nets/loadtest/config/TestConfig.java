...
public class TestConfig {
  ...
  public TestConfig(String baseUrl, int tpsOnboarding, String netsAppSecret, String appVersion,
      String codeVersion, int notificationLimit, double targetThroughput, String localBaseUrl) {
  ...
  public static TestConfig sitConfig() {
    return new TestConfig(ApiConstants.CIAM_SIT_BASE_URL, 2, "a2ugZ9xYfAZlRCzqGpeaxuJv5cCylAk8",
        "3.1.0", "01-04-2025", 100,

        60.0, "http://localhost:8080/"); // 60 requests/minute = 1 TPS
  }
  ...
  public static TestConfig uatConfig() {
    return new TestConfig(ApiConstants.CIAM_UAT_BASE_URL, 2, "ecd861eb-5539-4936-8806-c2e1c04a34ac",
        "3.1.0", "01-04-2025", 100,
  ...
  public static TestConfig uvmcTestConfig() {
    return new TestConfig(ApiConstants.UVMC_TEST_BASE_URL, 2, "", "3.1.0", "01-04-2025", 100, 60.0, // 60
                                                                                                    // requests/minute
                                                                                                    // =
                                                                                                    // 1
                                                                                                    // TPS
  ...
  public static TestConfig uvmcSitConfig() {
    return new TestConfig(ApiConstants.UVMC_SIT_BASE_URL, 2, "", "3.1.0", "01-04-2025", 100, 60.0, // 60
                                                                                                   // requests/minute
                                                                                                   // =
                                                                                                   // 1
                                                                                                   // TPS
